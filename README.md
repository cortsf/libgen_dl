...
This script needs exiftool (to set extensions) and Calibre's ebook-meta to read titles from the document metada. If no metadata is available it will only set the extension.
