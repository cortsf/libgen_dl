...
[[ "$1" == "--retry" ]] && { 
    ...
    aria2c  --console-log-level warn -j3 --max-tries 100 --retry-wait 5 -i ./libgen_dl/file_download_failures -l ./libgen_dl/file_download_log --save-session "libgen_dl/file_download_failures" --save-session-interval 2;
...
aria2c --console-log-level warn -j3 --max-tries 100 --retry-wait 5 -i ./libgen_dl/file_link_list.txt -l ./libgen_dl/file_download_log --save-session "libgen_dl/file_download_failures" --save-session-interval 2
